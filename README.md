# Dictionary for kpv — udm

This repository contains source files for a dictionary from Komi-Zyrian to Udmurt. The content is licensed under the CC-BY-4.0 license.
